...
package stdint_h is
   ...
   INT_FAST16_MIN : constant :=
     (-9_223_372_036_854_775_807 - 1);  --  /usr/include/stdint.h:154
   INT_FAST32_MIN : constant :=
     (-9_223_372_036_854_775_807 - 1);  --  /usr/include/stdint.h:155
   ...
   INT_FAST16_MAX : constant :=
     (9_223_372_036_854_775_807);  --  /usr/include/stdint.h:164
   INT_FAST32_MAX : constant :=
     (9_223_372_036_854_775_807);  --  /usr/include/stdint.h:165
   ...
   UINT_FAST16_MAX : constant :=
     (18_446_744_073_709_551_615);  --  /usr/include/stdint.h:175
   UINT_FAST32_MAX : constant :=
     (18_446_744_073_709_551_615);  --  /usr/include/stdint.h:176
   --  unsupported macro: UINT_FAST64_MAX (__UINT64_C(18446744073709551615))

   INTPTR_MIN : constant :=
     (-9_223_372_036_854_775_807 - 1);  --  /usr/include/stdint.h:186
   INTPTR_MAX : constant :=
     (9_223_372_036_854_775_807);  --  /usr/include/stdint.h:187
   UINTPTR_MAX : constant :=
     (18_446_744_073_709_551_615);  --  /usr/include/stdint.h:188
   ...
   PTRDIFF_MIN : constant :=
     (-9_223_372_036_854_775_807 - 1);  --  /usr/include/stdint.h:209
   PTRDIFF_MAX : constant :=
     (9_223_372_036_854_775_807);  --  /usr/include/stdint.h:210

   SIG_ATOMIC_MIN : constant :=
     (-2_147_483_647 - 1);  --  /usr/include/stdint.h:222
   SIG_ATOMIC_MAX : constant := (2_147_483_647);  --  /usr/include/stdint.h:223

   SIZE_MAX : constant :=
     (18_446_744_073_709_551_615);  --  /usr/include/stdint.h:227
   --  unsupported macro: WCHAR_MIN __WCHAR_MIN unsupported macro: WCHAR_MAX
   --  __WCHAR_MAX

   WINT_MIN : constant := (0);  --  /usr/include/stdint.h:244
   WINT_MAX : constant := (4_294_967_295);  --  /usr/include/stdint.h:245
   ...
   -- Small types.
   -- Signed.
   subtype int_least8_t is
     x86_64_linux_gnu_bits_types_h
       .uu_int_least8_t;  -- /usr/include/stdint.h:43

   subtype int_least16_t is
     x86_64_linux_gnu_bits_types_h
       .uu_int_least16_t;  -- /usr/include/stdint.h:44

   subtype int_least32_t is
     x86_64_linux_gnu_bits_types_h
       .uu_int_least32_t;  -- /usr/include/stdint.h:45

   subtype int_least64_t is
     x86_64_linux_gnu_bits_types_h
       .uu_int_least64_t;  -- /usr/include/stdint.h:46

   -- Unsigned.
   subtype uint_least8_t is
     x86_64_linux_gnu_bits_types_h
       .uu_uint_least8_t;  -- /usr/include/stdint.h:49

   subtype uint_least16_t is
     x86_64_linux_gnu_bits_types_h
       .uu_uint_least16_t;  -- /usr/include/stdint.h:50

   subtype uint_least32_t is
     x86_64_linux_gnu_bits_types_h
       .uu_uint_least32_t;  -- /usr/include/stdint.h:51

   subtype uint_least64_t is
     x86_64_linux_gnu_bits_types_h
       .uu_uint_least64_t;  -- /usr/include/stdint.h:52
   ...
   subtype intmax_t is
     x86_64_linux_gnu_bits_types_h.uu_intmax_t;  -- /usr/include/stdint.h:101

   subtype uintmax_t is
     x86_64_linux_gnu_bits_types_h.uu_uintmax_t;  -- /usr/include/stdint.h:102

   -- Limits of integral types.
   -- Minimum of signed integral types. Maximum of signed integral types.
   -- Maximum of unsigned integral types. Minimum of signed integral types
   -- having a minimum size. Maximum of signed integral types having a minimum
   -- size. Maximum of unsigned integral types having a minimum size. Minimum
   -- of fast signed integral types having a minimum size. Maximum of fast
   -- signed integral types having a minimum size. Maximum of fast unsigned
   -- integral types having a minimum size. Values to test for integral types
   -- holding `void *' pointer. Minimum for largest signed integral type.
   -- Maximum for largest signed integral type. Maximum for largest unsigned
   -- integral type. Limits of other integer types. Limits of `ptrdiff_t' type.
   -- Limits of `sig_atomic_t'. Limit of `size_t' type. Limits of `wchar_t'.
   -- These constants might also be defined in <wchar.h>. Limits of `wint_t'.
